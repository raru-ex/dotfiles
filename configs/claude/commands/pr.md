---
description: "プルリクエストの作成・更新を行うスラッシュコマンド。変更差分を確認し、適切なタイトルと説明文を生成します。"
---
...
判断に悩むものがある場合のみ、ユーザに確認を求めてコマンドを停止してください。
...
4. **PRタイトルと説明文の作成・提示**
確認した変更に基づいて、PRタイトルと説明文を作成し、**必ずユーザーに提示してください**：
...
- **PR説明**：
    ...
    - コンテキストが不明な場合は、背景情報をユーザーに確認してください
...
- 変更の背景や理由が不明な場合は、ユーザーに確認してから説明文を作成してください。
...
- **背景は推測せず確認する**：変更の理由や背景が不明な場合は、勝手に推測せずに必ずユーザーに確認してから記述する。
